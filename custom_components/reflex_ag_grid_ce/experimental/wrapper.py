...
def get_default_column_def(
    ...
    _cdef_kwargs = {
        ...
        "cell_editor": ag_grid_ce.editors.text,
    }
    _cdef_kwargs.update(cdef_kwargs)
    cdef = ag_grid_ce.column_def(
        field=field,
        **_cdef_kwargs,
    )
    ...
    if ftype in (int, float, bool):
        ...
        cdef.filter = ag_grid_ce.filters.number
        cdef.cell_editor = ag_grid_ce.editors.number
    if ftype is bool:
        cdef.cell_renderer = "agCheckboxCellRenderer"
        cdef.cell_editor = ag_grid_ce.editors.checkbox
    if ftype is datetime.datetime:
        cdef.filter = ag_grid_ce.filters.date
        cdef.cell_editor = ag_grid_ce.editors.date
