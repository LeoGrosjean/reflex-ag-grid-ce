...
class ColumnDef(PropsBase):
    #### Columns doc here
    # https://www.ag-grid.com/archive/32.3.3/react-data-grid/column-properties/#reference-columns

    field: Optional[str | rx.Var[str]]
    col_id: Optional[str | rx.Var[str]]
    type: Optional[str | rx.Var[str]]
    cell_data_type: Optional[bool | str | rx.Var[bool] | rx.Var[str]]

    # usage of value_getter & value_formatter:
    # rx.vars.function.ArgsFunctionOperation.create(
    #     ("p",),
    #     rx.Var("p.data.bronze + p.data.silver + p.data.gold"),
    # )
    value_getter: Optional[Callable] | rx.Var[Optional[Callable]]

    # usage of value_formatter:
    # rx.vars.function.ArgsFunctionOperation.create(
    #     ("p",),
    #     rx.Var("'$' + p.value"),
    # )
    value_formatter: Optional[Callable | rx.Var[Callable]]
    ...
    #### Display doc here
    # https://www.ag-grid.com/archive/32.3.3/react-data-grid/column-properties/#reference-display
...
class AgGrid(rx.Component):
    ...
    get_data_path: rx.vars.FunctionVar[Any] = None
